<template>
  <div class="min-h-full">
    <div class="bg-indigo-600 pb-32">
      <HeadlessDisclosure v-slot="{ open }" as="nav" class="border-b border-indigo-300 border-opacity-25 bg-indigo-600 lg:border-none">
        <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
          <div class="relative flex h-16 items-center justify-between lg:border-b lg:border-indigo-400 lg:border-opacity-25">
              ...
              <div class="w-full max-w-lg lg:max-w-xs">
                ...
                <div class="relative text-gray-400 focus-within:text-gray-600">
                  <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    <Icon name="heroicons-solid:search" class="h-5 w-5" aria-hidden="true" />
                  </div>
            ...
            <div class="flex lg:hidden">
              <!-- Mobile menu button -->
              <HeadlessDisclosureButton class="relative inline-flex items-center justify-center rounded-md bg-indigo-600 p-2 text-indigo-200 hover:bg-indigo-500 hover:bg-opacity-75 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600">
                <span class="absolute -inset-0.5" />
                <span class="sr-only">Open main menu</span>
                <Icon v-if="!open" name="heroicons-outline:menu" class="block h-6 w-6" aria-hidden="true" />

                <Icon v-else name="heroicons-outline:x" class="block h-6 w-6" aria-hidden="true" />
            ...
            <div class="hidden lg:ml-4 lg:block">
              <div class="flex items-center">
                <button type="button" class="relative flex-shrink-0 rounded-full bg-indigo-600 p-1 text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600">
                  ...
                  <Icon name="heroicons-outline:bell" class="h-6 w-6" aria-hidden="true" />
                </button>
              </div>
            </div>
          </div>
