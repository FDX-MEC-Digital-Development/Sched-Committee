  ...
  <form>
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        <div v-auto-animate class="xs:mt-3 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <UFormGroup v-if="options.isGrid" label="Inbound flight segment" class="sm:col-span-4">
          ...
          <UFormGroup v-if="options.isGrid" label="Layover length (hours)" class="sm:col-span-4">
