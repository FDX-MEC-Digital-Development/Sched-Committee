...
const accordionItems = [
  ...
  },
  {
    ...
    defaultOpen: false,
    content: 'You do not have to call out fatigued to file a fatigue report. You can submit a fatigue report anytime. Help us identify fatigue hazards – anything that reduces your rest and increases your workload.',
  },
  {
    label: 'Example: Successful CRS Schedule Revision',
    defaultOpen: false,
    content: 'Recent example: pilots were revised to catch a 0300 operational jumpseat and then operate to MEM. They called CRS and said this was a challenging flip of their schedule, it would be hard to get immediate rest and then operate during the critical period. CRS looked at their pairing and were able to revise the pairing and keep them on their current circadian clock. No fatigue call was needed.',
  },
